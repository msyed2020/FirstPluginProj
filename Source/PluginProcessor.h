...
public:
    ...
    juce::AudioProcessorValueTreeState apvts{ AudioProcessor & processorToConnect,
    UndoManager * undoManagerToUse, const Identifier & valueTreeType, ParameterLayout parameterLayout };
